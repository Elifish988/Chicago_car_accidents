...
def test_count_accidents_by_region_and_period(init_test_data):
    count = count_accidents_by_region_and_period(init_test_data,'225', 'day', '01/01/2024')
    assert count == 1

def test_count_accidents_by_cause_and_region(init_test_data):
    cause_count = count_accidents_by_cause_and_region(init_test_data,'225')
...
def test_get_accident_statistics(init_test_data):
    stats = get_accident_statistics(init_test_data,'225')
